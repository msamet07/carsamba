...
function Kullanici(isim) {
  ...
  this.yazdir= function(){
    return "isimim ; " + this.isim
  }
}

let adam = new Kullanici("ihsan");
let adam3 =new Kullanici("Samet");

//console.log(adam3.yazdır());
...
function Araba(model, tuketim) {
  ...
  this.drive = function (distance) {
    ...
    if(this.tank<=0){
      ...
      this.odemeter+=extraMile;
      this.tank=0;
      console.log (`${this.odemeter} milde benzinin bitti `)
    }
  }
}
let vw = new Araba ("possat", 15);
vw.fill(65);
vw.drive(10);
vw.drive(5);
console.log(vw.tank);
console.log(vw.odemeter);
